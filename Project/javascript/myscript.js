...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Yêu em " + (thePercent+900) + "% luôn. Load xong nhấn vào đây trước nhen bé";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp; Ỏ cưng dọ, kêu nhấn là nhấn <:';
document.querySelector('.Description .modal-body').innerHTML = 'Thưn thưn, giờ ra nhấn cái kia nha bae <i class="fas fa-heart"></i> ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";
author.innerHTML = "Bản quyền thuộc về<a href='https://yeuba.com'>Lmint<a>";
